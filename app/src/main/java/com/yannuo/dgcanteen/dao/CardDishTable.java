...
public class CardDishTable {
    ...
    @Generated(hash = 103941023)
    private transient CardDishTableDao myDao;

    @Generated(hash = 1779554159)
    public CardDishTable(Long id, Long orderid, String dishesId, String dishesName,
    ...
    @Generated(hash = 1331470449)
    public CardDishTable() {
    }
    ...
    @Generated(hash = 473899563)
    public CardPay getOrder() {
        ...
        if (order__resolvedKey == null || !order__resolvedKey.equals(__key)) {
            ...
            CardPayDao targetDao = daoSession.getCardPayDao();
            CardPay orderNew = targetDao.load(__key);
            synchronized (this) {
                order = orderNew;
    ...
    @Generated(hash = 758096640)
    public void setOrder(CardPay order) {
        synchronized (this) {
            this.order = order;
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 135419107)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getCardDishTableDao() : null;
    }
