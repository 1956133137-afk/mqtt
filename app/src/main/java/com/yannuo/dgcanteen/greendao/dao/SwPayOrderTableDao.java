...
/** 
 * DAO for table "SW_PAY_ORDER_TABLE".
*/
public class SwPayOrderTableDao extends AbstractDao<SwPayOrderTable, Long> {

    public static final String TABLENAME = "SW_PAY_ORDER_TABLE";

    /**
     * Properties of entity SwPayOrderTable.<br/>
    ...
    public SwPayOrderTableDao(DaoConfig config) {
        super(config);
    }
    
    public SwPayOrderTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SW_PAY_ORDER_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SW_PAY_ORDER_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SwPayOrderTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SwPayOrderTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(SwPayOrderTable entity) {
    ...
    @Override
    public SwPayOrderTable readEntity(Cursor cursor, int offset) {
        SwPayOrderTable entity = new SwPayOrderTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, SwPayOrderTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SwPayOrderTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SwPayOrderTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SwPayOrderTable entity) {
