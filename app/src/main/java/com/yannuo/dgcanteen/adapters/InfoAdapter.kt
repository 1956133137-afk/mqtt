...
import com.yannuo.dgcanteen.databinding.ItemInfoBinding
 ...
 **/
class InfoAdapter : BaseAdapter<InfoBean, ItemInfoBinding>() {
    override fun getB(inflater: LayoutInflater, parent: ViewGroup): ItemInfoBinding {
