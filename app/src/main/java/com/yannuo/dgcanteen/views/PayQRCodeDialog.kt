...
class PayQRCodeDialog(context :Context) :BaseDialog(context, R.layout.dialog_pay_qrcode) {
    private val TAG = javaClass.simpleName
    private val time = 60L
    private lateinit var tv_close : ImageButton
    private lateinit var tv_count  :TextView
    private lateinit var iv_pay_qrcode :ImageView
    ...
    override fun initViewAndEvent() {
        ...
        iv_pay_qrcode = findViewById(R.id.iv_pay_qrcode)
    ...
    override fun show() {
        super.show()
        iv_pay_qrcode.setImageBitmap(bitmap)
        countDown?.cancel()
