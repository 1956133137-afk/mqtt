...
//        startService(intent);
    ...
    public void initMMKV() {
        ...
        //调试模式
        if (res) {
            if (kv.decodeString(Constant.ADDRESS) == null) kv.encode(Constant.ADDRESS, "https://test.yannuozhineng.com/ccb/canteen/api/");
            if (kv.decodeString(Constant.PERSON_ADDRESS) == null) kv.encode(Constant.PERSON_ADDRESS, "https://static-test.yannuozhineng.com/");
            ...
            if (kv.decodeString(Constant.ADDRESS) == null) kv.encode(Constant.ADDRESS, "https://canteen.yannuozhineng.com/api/");
            if (kv.decodeString(Constant.PERSON_ADDRESS) == null) kv.encode(Constant.PERSON_ADDRESS, "https://static.yannuozhineng.com/");
